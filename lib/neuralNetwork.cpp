...
Net::Net(const vector<unsigned> &topology, double newEta, double newAlpha)
{
...
void Net::train(int iterations, int numData, vector<int> vClass, vector<double> vOpen, vector<double> vClose)
{
...
int Net::validate(double open, double close)
{
    vector<double> resultVals;
    vector<double> entryVals;
